...
public class InstantSpawnerBlock extends BaseEntityBlock {
    public InstantSpawnerBlock(Properties properties) {
        super(properties);
    }
    ...
    public @Nullable BlockEntity newBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new IllagersSpawnerBlockEntity(blockPos, blockState);
    }
