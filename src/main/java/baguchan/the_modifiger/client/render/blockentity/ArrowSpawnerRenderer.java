...
public class ArrowSpawnerRenderer implements BlockEntityRenderer<ArrowSpawnerBlockEntity> {
    private final EntityRenderDispatcher entityRenderer;

    public ArrowSpawnerRenderer(BlockEntityRendererProvider.Context p_173673_) {
        this.entityRenderer = p_173673_.getEntityRenderer();
    }

    @Override
    public void render(ArrowSpawnerBlockEntity p_112563_, float p_112564_, PoseStack p_112565_, MultiBufferSource p_112566_, int p_112567_, int p_112568_) {
        p_112565_.pushPose();
        p_112565_.translate(0.5F, 0.0F, 0.5F);
        ArrowSpawner $$6 = p_112563_.getSpawner();
