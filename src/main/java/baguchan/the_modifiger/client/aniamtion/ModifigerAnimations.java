package baguchan.the_modifiger.client.aniamtion;// Save this class in your mod and generate all required imports
...
public class ModifigerAnimations {
	...
	public static final AnimationDefinition idle = AnimationDefinition.Builder.withLength(2.0F)
		...
		.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(-128.194F, 0.8121F, 14.7225F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.75F, KeyframeAnimations.degreeVec(-128.19F, 0.81F, 14.72F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.0F, KeyframeAnimations.degreeVec(-132.3571F, -31.0376F, 30.004F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(1.5F, KeyframeAnimations.degreeVec(-132.36F, -31.04F, 30.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(2.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
		))
		.addAnimation("right_arm", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.25F, KeyframeAnimations.posVec(-1.0F, 4.0F, 2.0F), AnimationChannel.Interpolations.CATMULLROM),
	...
	public static final AnimationDefinition building = AnimationDefinition.Builder.withLength(1.0F).looping()
	...
	public static final AnimationDefinition calling = AnimationDefinition.Builder.withLength(1.0F)
