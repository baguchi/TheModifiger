...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ILLAGERS_SPAWNER = register("illagers_spawner", () -> new InstantSpawnerBlock(BlockBehaviour.Properties.of().strength(3.5F, 5.0F).noOcclusion().requiresCorrectToolForDrops().noLootTable().sound(SoundType.NETHERITE_BLOCK)));
    public static final RegistryObject<Block> ARROW_SPAWNER = register("arrow_spawner", () -> new ArrowSpawnerBlock(BlockBehaviour.Properties.of().strength(3.5F, 5.0F).noOcclusion().requiresCorrectToolForDrops().noLootTable().sound(SoundType.NETHERITE_BLOCK)));
