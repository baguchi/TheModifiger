...
public class IllagersSpawnerBlockEntity extends BlockEntity {
    protected final BaseIllagerSpawner spawner = new BaseIllagerSpawner() {
        public void broadcastEvent(Level p_155767_, BlockPos p_155768_, int p_155769_) {
            p_155767_.blockEvent(p_155768_, ModBlocks.ILLAGERS_SPAWNER.get(), p_155769_, 0);
        }
        ...
        public @org.jetbrains.annotations.Nullable BlockEntity getSpawnerBlockEntity() {
            return IllagersSpawnerBlockEntity.this;
        }
    };

    public IllagersSpawnerBlockEntity(BlockPos p_155752_, BlockState p_155753_) {
        super(ModBlockEntitys.ILLAGERS_SPAWNER.get(), p_155752_, p_155753_);
    }
    ...
    public static void clientTick(Level p_155755_, BlockPos p_155756_, BlockState p_155757_, IllagersSpawnerBlockEntity p_155758_) {
        p_155758_.spawner.clientTick(p_155755_, p_155756_);
    }

    public static void serverTick(Level p_155762_, BlockPos p_155763_, BlockState p_155764_, IllagersSpawnerBlockEntity p_155765_) {
    ...
    public BaseIllagerSpawner getSpawner() {
        return this.spawner;
    }
}
